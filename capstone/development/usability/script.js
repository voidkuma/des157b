(function(){
    ...
    const userTestTXT = document.querySelector('#testOverlay');
    const usetStartBTN = document.querySelector('#testSTART');

    usetStartBTN.addEventListener('click', function(){
        userTestTXT.className = 'hidden';
